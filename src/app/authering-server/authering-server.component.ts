...
@Component({
  selector: 'app-authering-server',
  templateUrl: './authering-server.component.html',
  // styleUrls: ['./authering-server.component.css']
  styleUrls: ['../app.component.css']
})

export class AutheringServerComponent implements OnInit {
