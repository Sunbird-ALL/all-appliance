...
//# sourceURL=token.js
org.ekstep.pluginframework.pluginManager.registerPlugin({"id":"org.ekstep.courseunitmeta","ver":"1.7","author":"Kartheek Palla","title":"Course Unit Meta plugin","description":"","publishedDate":"","editor":{"main":"editor/plugin.js","dependencies":[{"plugin":"org.ekstep.assetbrowser","ver":"1.2","type":"plugin"},{"plugin":"org.ekstep.topicselector","ver":"1.0","type":"plugin"},{"type":"css","src":"editor/libs/tokens.css"},{"type":"js","src":"editor/libs/tokens.js"},{"type":"plugin","plugin":"org.ekstep.metadata","ver":"1.5"}],"views":[{"template":"./courseunitmeta.html","controller":"./courseunitmetaApp.js"}]}},org.ekstep.collectioneditor.basePlugin.extend({initialize:function(){var e=ecEditor.resolvePluginResource(this.manifest.id,this.manifest.ver,"editor/courseunitmeta.html"),t=ecEditor.resolvePluginResource(this.manifest.id,this.manifest.ver,"editor/courseunitmetaApp.js");org.ekstep.collectioneditor.api.registerMetaPage({objectType:["CourseUnit"],templateURL:e,controllerURL:t})}}))